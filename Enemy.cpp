...
void Enemy::createBullet(const int& x_border,const int& y_border,SDL_Renderer* screen,const float &player_pos_x,const float&player_pos_y,std::vector <Bullet*> &e_bullets) {
...
void Enemy::B_createBullet(const int& x_border,const int& y_border,SDL_Renderer* screen,const float &player_pos_x,const float&player_pos_y,std::vector <Bullet*> &b_bullets) {
